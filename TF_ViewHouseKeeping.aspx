<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_ViewHouseKeeping.aspx.cs"
    Inherits="TF_ViewHouseKeeping" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="lblHeader" class="pageLabel" Text="User Management View" runat="server"
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewUsers" runat="server" AutoGenerateColumns="False" Width="60%"
                                        ...
                                        <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" ToolTip="Delete Record" CommandName="RemoveRecord"
                                                    CommandArgument='<%#Eval("userName")%>' Text="Delete" BackColor="#007DFB" Width="100%"
                                                    Font-Bold="true" ForeColor="White" Font-Size="11px" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
