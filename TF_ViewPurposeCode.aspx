                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewPurposeCodes" runat="server" AutoGenerateColumns="False"
                                    Width="51%" GridLines="Both" AllowPaging="true" OnRowCommand="GridViewPurposeCodes_RowCommand"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Purpose Code" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" ToolTip="Delete Record" CommandName="RemoveRecord"
                                                    CommandArgument='<%#Eval("purposeID")%>' Text="Delete" BackColor="#007DFB" Width="100%" Font-Bold="true" ForeColor="White" Font-Size="11px"/>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
