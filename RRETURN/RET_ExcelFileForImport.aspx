<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RET_ExcelFileForImport.aspx.cs" Inherits="RRETURN_RET_ExcelFileForImport" %>
...
<body>
    <form id="form1" runat="server" autocomplete="off" unselectable="off">
        ...
        <br />
        <div align="left">
            <span class="pageLabel" style="font-weight: bold">Excel File Creation For Import</span>
            <hr />
            <table>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        <div>
                            <asp:LinkButton ID="lnkEDownload" runat="server" Visible="false" Text="Download File" CssClass="buttonDefault"
                                OnClick="lnkEDownload_Click"></asp:LinkButton>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="left" colspan="4" style="width: 249px;">
                ...
                <tr>
                    ...
                    <td align="left" colspan="4"> 
                        <asp:Button ID="btnCreate" runat="server" Text="Create Excel File" CssClass="buttonDefault"
                            ToolTip="Create Excel File" TabIndex="3" OnClick="btnCreate_Click" />
