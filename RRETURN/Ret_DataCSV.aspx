    ...
    <script language="javascript" type="text/javascript">
        function validateControl() {
            ...
            if (selectedBranch == "GIFT CITY") {
                alert('This Branch is Not Allowed For This Operation.');
                return false;
            }
            if (fromdate.value == '') {
...
<body>
    ...
    <br />
    <div align="left">
        <span class="pageLabel" style="font-weight: bold">File Extraction For HO</span>
        <hr />
                ...
                <table>
                    <tr>
                        ...
                        <td align="left" class="style5">
                            <asp:Label ID="txters" runat="server" Width="130%"></asp:Label>
                        </td>
                        <td align="left">
                            &nbsp;&nbsp;&nbsp;<asp:PlaceHolder ID="ersfile" runat="server"></asp:PlaceHolder>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left" class="style5">
                            <asp:Label ID="txtnostro" runat="server" Width="130%"></asp:Label>
                        </td>
                        <td align="left" class="style2">
                            &nbsp;&nbsp;&nbsp;<asp:PlaceHolder ID="nostrofile" runat="server"></asp:PlaceHolder>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left" class="style5">
                            <asp:Label ID="txtvostro" runat="server" Width="130%"></asp:Label>
                        </td>
                        <td align="left" class="style2">
                            &nbsp;&nbsp;&nbsp;<asp:PlaceHolder ID="vostrofile" runat="server"></asp:PlaceHolder>
                        </td>
                    </tr>
                    <tr>
                        <td>
