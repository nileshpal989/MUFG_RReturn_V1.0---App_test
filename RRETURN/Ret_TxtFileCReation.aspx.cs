...
swSCH3TO6.Dispose();*/
    ...
    protected void lnkQEDownload_Click(object sender, EventArgs e)
    {
        ...
        if (Branchname == "GIFT CITY")
        {
            filePath = "~/TF_GeneratedFiles/RRETURN/ERS/BR_" + Branchname.Replace(" ", "") + "_RBI_ERS/" + qe + "644_QE.txt";
    ...
    protected void lnkBOP6Download_Click(object sender, EventArgs e)
    {
        ...
        if (Branchname == "GIFT CITY")
        {
            filePath = "~/TF_GeneratedFiles/RRETURN/ERS/BR_" + Branchname.Replace(" ", "") + "_RBI_ERS/" + bop6 + "644_BOP6.txt";
            FileName = bop6 + "644_BOP6.txt";
            lblqename.Text = bop6 + "I644_BOP6.txt";
        }
        else
        {
            filePath = "~/TF_GeneratedFiles/RRETURN/ERS/BR_" + Branchname.Replace(" ", "") + "_RBI_ERS/644_BOP6.txt";
            FileName = "644_BOP6.txt";
