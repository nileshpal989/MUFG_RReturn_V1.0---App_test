<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ret_TxtFileCReation.aspx.cs" Inherits="RRETURN_Ret_TxtFileCReation" %>
...
<body>
    <form id="form1" runat="server" autocomplete="off" unselectable="off">
        ...
        <br />
        <div align="left">
            <asp:HiddenField ID="hdnQE" runat="server" Value="IB"/>
            <asp:HiddenField ID="hdnBOP6" runat="server" Value="IB"/>
