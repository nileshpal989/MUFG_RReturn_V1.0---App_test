<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_rpt_LoginLog.aspx.cs"
    Inherits="TF_rpt_LoginLog" %>
                    ...
                    <table cellspacing="0" border="0" width="100%">
                        <tr>
                            <td align="left" style="width: 50%" valign="bottom">
                                <asp:Label ID="PageHeader" CssClass="pageLabel" runat="server" Style="font-weight: bold"
                                    Text="User Login Activity Details"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RadioButton ID="rdbAllCustomer" runat="server" CssClass="elementLabel" GroupName="Data1"
                                                TabIndex="4" Text="All Users" Checked="true" />&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:RadioButton ID="rdbSelectedCustomer" runat="server" CssClass="elementLabel"
                                                GroupName="Data1" TabIndex="4" Text="Selected User" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div id="divUser">
                                                <span class="elementLabel">User :</span><asp:TextBox ID="txtUserName" CssClass="textBox"
                                                    runat="server" TabIndex="5" OnTextChanged="txtUserName_TextChanged" AutoPostBack="true">
                                                </asp:TextBox><asp:Button ID="btnUserList" CssClass="btnHelp_enabled" runat="server"
                                                    TabIndex="-1" />
