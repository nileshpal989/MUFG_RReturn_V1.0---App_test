...
public partial class TF_AuditTrail_LoginLogOut : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Reports/View_rptAuditTrail.aspx?PageHeader=" + Report + "&frm=" + txtFromDate.Text + "&to=" + txtToDate.Text + "&Branch=" + Branch + "&UserName=" + UserName + "&Report=" + Report);
