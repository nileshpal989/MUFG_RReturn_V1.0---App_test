<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_AdminAuditTrail.aspx.cs"
    Inherits="TF_AdminAuditTrail" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function PurposeCodehelp() {
            ...
            popup = window.open('TF_RRETURN_PurposecodeLookup.aspx?PageHeader=Purpose Code LookUp', 'helpPurposeId', 'height=520,  width=520,status= no, resizable= no, scrollbars=yes, toolbar=no,location=center,menubar=no, top=100, left=300');
        ...
        function validateSave() {
            ...
            if (document.getElementById('rdbAllTypes').checked == true) {
                alert('The "All" radio button includes reports for user creation, deletion, and modification. For the User Access Control report, please select the "User Access Control" radio button. Click "OK" to continue.');
                //user='All'
            }
        }
    </script>
                        ...
                        <table cellspacing="0" border="0" width="100%">
                            <tr>
                                <td align="left" style="width: 50%" valign="bottom">
                                    ...
                                    <asp:Label ID="PageHeader" Text="Admin AuditTrail" CssClass="pageLabel" runat="server"
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" width="800px" style="line-height: 150%">
                                        <tr>
                                            ...
                                            <td align="left" nowrap>&nbsp;<asp:DropDownList ID="ddlBranch" CssClass="dropdownList" TabIndex="1" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged"
                                                AutoPostBack="true" Width="100px" runat="server" Style="visibility: hidden">
                                            </asp:DropDownList>
                                        ...
                                        <tr>
                                            ...
                                            <%--  //<br />--%>
                                                <asp:RadioButton ID="rdbSelectedPurposeCode" runat="server" AutoPostBack="true" CssClass="elementLabel"
                                                    ...
                                                    Text="User Deletion" />
                                                &nbsp;&nbsp;&nbsp;
                                                <asp:RadioButton ID="rdbUserAccess" runat="server" AutoPostBack="true" CssClass="elementLabel"
                                                    GroupName="Data2" OnCheckedChanged="rdbUserAccess_CheckedChanged" TabIndex="7"
                                    ...
                                    <table>
                                        <tr valign="bottom">
                                            ...
                                            <asp:Button ID="btnSave" runat="server" CssClass="buttonDefault" Text="Generate"
                                                ToolTip="Generate" TabIndex="10" OnClick="btnSave_Click" />
