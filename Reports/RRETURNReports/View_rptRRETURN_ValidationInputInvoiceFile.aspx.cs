...
public partial class Reports_RRETURNReports_View_rptRRETURN_ValidationInputInvoiceFile : System.Web.UI.Page
{
        ...
        if (!Page.IsPostBack)
        {
            ...
            {                
                try
                {
                    ...
                    serverReport.ReportPath = "/MUFG_TF_Reports/rptRRETURN_Validate_Input_File";
                    ...
                    branch.Name = "ADCode";
                    branch.Values.Add(Request.QueryString["ADCode"]);
                ...
                catch (Exception Ex)
                {
                    ...
                    ADCODE.Value = Request.QueryString["ADCode"];
