...
public partial class Reports_RRETURNReports_View_rptRRETURN_NostroReport : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["frm"] != null && Request.QueryString["to"] != null)
            {
                try
                {
                    ...
                    switch (Request.QueryString["Report"])
                    {
                        case "RRETURN Report to RBI(Nostro)":
                            ...
                            serverReport.ReportPath = "/MUFG_TF_Reports/rptRRETURN_Nostro";
                            break;

                        case "Consolidated R RETURN Report to RBI(Nostro)":
                            serverReport.ReportPath = "/MUFG_TF_Reports/rptConsolRRETURN_Nostro";
                            break;
                    }
                ...
                catch (Exception Ex)
                {
                    ...
                    Response.Redirect("../../RRETURN/ErrorPage.aspx?Error Page");
                }
            }
        }
    }
    ...
    {
        Response.Redirect("rptRRETURN_NostroReport.aspx?PageHeader=" + PageHeader.Text, true);
    }
}