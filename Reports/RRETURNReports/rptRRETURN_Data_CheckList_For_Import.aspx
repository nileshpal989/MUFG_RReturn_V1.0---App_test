<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptRRETURN_Data_CheckList_For_Import.aspx.cs"
    Inherits="Reports_RRETURNReports_rptRRETURN_Data_CheckList_For_Import" %>
                                    ...
                                    <tr>
                                        <td align="right" style="width: 220px; padding-top: 10px; padding-bottom: 10px" valign="bottom">
                                            ...
                                            <asp:Button ID="btnSave" runat="server" CssClass="buttonDefault" Text="Generate Report"
                                                ToolTip="Generate" TabIndex="4" Width="135px" OnClick="btnSave_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
