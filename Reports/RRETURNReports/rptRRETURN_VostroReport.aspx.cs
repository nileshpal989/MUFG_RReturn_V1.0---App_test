...
public partial class Reports_RRETURNReports_rptRRETURN_VostroReport : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
            ...
            var Currency = ddlCurrency.SelectedItem.Text;   
            var Report = PageHeader.Text;

            Response.Redirect("View_rptRRETURN_VostroReport.aspx?PageHeader=" + Report + "&frm=" + txtfromDate.Text + "&to=" + txtToDate.Text + "&Branch=" + Branch + "&Currency=" + Currency+ "&Report=" + Report + "&txtAuthSign=" + txtAuthSign.Text + "&txtserialNo=" + txtserialNo.Text);
