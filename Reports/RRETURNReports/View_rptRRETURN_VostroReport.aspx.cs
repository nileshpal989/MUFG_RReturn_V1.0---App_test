...
public partial class Reports_RRETURNReports_View_rptRRETURN_VostroReport : System.Web.UI.Page
{
                ...
                try
                {
                    ...
                    switch (Request.QueryString["Report"])
                    {
                        case "R RETURN Report to RBI(Vostro)":
                            serverReport.ReportPath = "/MUFG_TF_Reports/rptRRETURN_VostroReport";
                            break;

                        case "Consolidated R RETURN Report to RBI(Vostro)":
                            serverReport.ReportPath = "/MUFG_TF_Reports/rptConsolRRETURN_Vostro";
                            break;
                    }
    ...
    {
        Response.Redirect("rptRRETURN_VostroReport.aspx?PageHeader=" + PageHeader.Text, true);
    }
}