                                        ...
                                        <td>
                                            <div id="divUser" runat="server" visible="false">
                                                <span class="elementLabel">User :</span><asp:TextBox ID="txtUserName" CssClass="textBox"
                                                    runat="server" TabIndex="5" OnTextChanged="txtUserName_TextChanged" AutoPostBack="true"></asp:TextBox><asp:Button ID="btnUserList" CssClass="btnHelp_enabled"
                                                        runat="server" TabIndex="-1" /><asp:Label ID="lblUserName" runat="server" CssClass="elementLabel"
                                        ...
                                        <td>
                                            <asp:RadioButton ID="rdbAllTypes" runat="server" CssClass="elementLabel" GroupName="Data2"
                                                TabIndex="6" Text="All TYPES" Checked="true" />&nbsp;&nbsp;<asp:RadioButton ID="rdbAdd"
                                                    runat="server" CssClass="elementLabel" GroupName="Data2" TabIndex="6" Text="ADD" />&nbsp;&nbsp;<asp:RadioButton
                                                        ID="rdbModify" runat="server" CssClass="elementLabel" GroupName="Data2" TabIndex="6"
                                                        Text="MODIFY" />&nbsp;&nbsp;<asp:RadioButton ID="rdbDelete" runat="server" CssClass="elementLabel"
                                                            GroupName="Data2" TabIndex="6" Text="DELETE" />&nbsp;&nbsp;<asp:RadioButton
                                                                ID="rdbFileUpload" runat="server" CssClass="elementLabel" GroupName="Data2" TabIndex="6"
                                                                Text="File Upload" />&nbsp;&nbsp;<asp:RadioButton ID="rdbFileCreation" runat="server"
                                                                    CssClass="elementLabel" GroupName="Data2" TabIndex="6" Text="File Creation" />
                                        </td>
                                    </tr>
                                </table>
                                <table>
