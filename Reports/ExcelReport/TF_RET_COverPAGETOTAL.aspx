<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TF_RET_COverPAGETOTAL.aspx.cs" Inherits="Reports_ExcelReport_TF_RET_COverPAGETOTAL" %>
                                        ...
                                        <tr>
                                            ...
                                            <%-- TO DATE--%>
                                                ...
                                                &nbsp;<asp:TextBox ID="txtToDate" runat="server" CssClass="textBox" MaxLength="10"
                                                    Width="70" TabIndex="3" ValidationGroup="dtVal" AutoPostBack="true"></asp:TextBox>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <asp:Button ID="btnSave" runat="server" CssClass="buttonDefault" Text="Generate Report"
                                                ToolTip="Generate" TabIndex="4" Width="135px" OnClick="btnExport_Click" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
