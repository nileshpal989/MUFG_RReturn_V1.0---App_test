                ...
                <contenttemplate>
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr id="rowGrid" runat="server">
                            <td align="left" style="width: 100%" valign="top" colspan="2">
                                <asp:GridView ID="GridViewCurrency" runat="server" AutoGenerateColumns="False" Width="40%"
                                    GridLines="Both" AllowPaging="true" OnRowCommand="GridViewCurrency_RowCommand"
                                    OnRowDataBound="GridViewCurrency_RowDataBound">
                                        ...
                                        <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnDelete" runat="server" ToolTip="Delete Record" CommandName="RemoveRecord"
                                                    CommandArgument='<%#Eval("C_Code")%>' Text="Delete" BackColor="#007DFB" Width="100%" Font-Bold="true" ForeColor="White" Font-Size="11px"/>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
